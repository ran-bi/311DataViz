...
## Graphs
```{r theming, echo=FALSE, message=FALSE, warning = FALSE}
...
requests %>% 
  ...
  labs(x = "Month", y = "Year", 
       ...
       title = "Graffiti Incidents Peak in Mar & Aug", 
...
```{r fig.width=7, fig.height=8,echo=FALSE, message=FALSE, warning = FALSE}
...
requests %>%
  ...
  labs(x = "Total Number of Requests", y = "Graffiti Surface Type", 
       title = "Graffiti Removal Requests by Top Surface Type", 
